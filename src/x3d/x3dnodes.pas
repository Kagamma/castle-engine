...
uses SysUtils, Generics.Collections, Classes, XMLRead, DOM,
  ...
  CastleTextureImages, CastleKeysMouse, {$ifndef FPC_WEB}CastleSoundEngine,{$endif} CastleStringUtils,
...
uses
  ...
  Math, X3DLoad, {$ifndef FPC_WEB}CastleInternalZStream,{$endif} X3DCameraUtils,
...
{$ifndef FPC_WEB_FIXME}{$I auto_generated_node_helpers/x3dnodes_audioclip.inc}{$endif}
...
{$ifndef FPC_WEB_FIXME}{$I auto_generated_node_helpers/x3dnodes_sound.inc}{$endif}
...
{$ifndef FPC_WEB_FIXME}{$I auto_generated_node_helpers/x3dnodes_x3dsoundnode.inc}{$endif}
{$ifndef FPC_WEB_FIXME}{$I auto_generated_node_helpers/x3dnodes_x3dsoundsourcenode.inc}{$endif}
